...
7. Falls back to a sparse on-disk placeholder tree if ProjFS is unavailable on the machine.
...
- if ProjFS is unavailable, the app falls back to a sparse placeholder tree mounted to the requested drive letter
